  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (password.length >= 8) {
      ...
      createUserWithEmailAndPassword(auth, email, password)
        ...
        .catch((error) => {
          setLoading(false);
          toast.error("Failed to create account. Please try again.", { position: "top-center" });
        });
    } else {
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div>
                ...
                {passwordLenError && <p className="text-red-600 font-normal">Error: password must be at least 8 characters!</p>}
